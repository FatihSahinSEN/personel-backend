...
class SigortaSirketleri extends ResourceController
{
    use ResponseTrait;
    ...
    {
        $this->model = new SigortaSirketleriModel();
    }
    ...
    public function create()
    {
        ...
        if($kontrol){
            $response = [
                'status' => false,
                'code' => 200,
                'message' => 'ERR_SIGORTA_SIRKETI_MEVCUT'
            ];
            return $this->respond($response,$response["code"]);
        }
        ...
        if ($Create) {
            ...
            $response = [
                'status' => true,
                'code' => 201,
                'message' => 'MSG_SIGORTA_SIRKETI_OLUSTURULDU',
                'result' => $data
            ];
            return $this->respond($response,$response["code"]);
        } else {
    ...
    public function show($id = null)
    {
        ...
        if($data){
            ...
            $response = [
                'status' => false,
                'code'   => 200,
                'message' => 'ERR_SIGORTA_SIRKETI_BULUNAMADI',
            ];
            return $this->respond($response,$response['code']);
        }
    }
    ...
    public function delete($id = null)
    {
        ...
        if($data){
            ...
            $response = [
                'status'   => 200,
                'error'    => null,
                'message' => 'ERR_SIGORTA_SIRKETI_SILINDI'
            ];
            return $this->respondDeleted($response);
        }else{
            return $this->failNotFound('ERR_SIGORTA_SIRKETI_BULUNAMADI');
        }
    }
}